...
def print_beam():  # ligne plus moins sans séparateur
    print('+ - - - -', end=' ')


def print_post():  # ligne pipe space sans séparateur
    print('|        ', end=' ')


def print_beams():  # ligne plus moins complète
    do_twice(print_beam)
    print('+')


def print_posts():  # ligne pipe space complète
    do_twice(print_post)
    print('|')


def print_row():  # rangée complète
    print_beams()
    do_four(print_posts)


def print_grid():  # grille 4x4 complète
    do_twice(print_row)  # 2 rangée et une ligne finale de plus moins
    print_beams()
